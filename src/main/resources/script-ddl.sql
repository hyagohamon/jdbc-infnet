...
values (null, 'Macarrão a bolonheza', 100);
insert into produto (codigo, descricao, preco)
values (null, 'Bife com fritas', 200);
insert into produto (codigo, descricao, preco)
values (null, 'Coca-cola', 8);
...
insert into pedido (codigo, data, cliente_cod)
values (null, '2022-10-22', 4);
...
select p.codigo, p.data, c.nome, pr.descricao, pr.preco
from pedido p
         join cliente c
         join itens_pedido i
         join produto pr
